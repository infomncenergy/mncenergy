...
const CONTACT_CARDS = [
  ...
  },
  {
    icon: 'bi-whatsapp',
    title: 'WhatsApp',
    lines: ['Chat with our team', 'Fast response guaranteed'],
  ...
  },
  {
    ...
    title: 'Email Us',
    lines: ['info@landlordsafetycertificate.co.uk', 'Reply within 24 hours'],
    href:  'mailto:info@landlordsafetycertificate.co.uk',
    cta:   'Send Email',
    color: 'blue',
  },
  {
    ...
    title: 'Coverage Area',
    lines: ['London & the M25', 'Engineers available 7 days a week'],
    href:  null,
    cta:   null,
    color: 'amber',
  },
          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-7">
              ...
              <p className="text-muted mb-4" style={{ fontSize: '1.1rem' }}>
                Have a question about our services, need a quote, or want to check your certificate? Our team is here to help. We aim to respond to all enquiries within 24 hours.
              </p>
              <div className="d-flex gap-3 flex-wrap">
                <div className="booking-hero__badge">
                  <i className="bi bi-clock-fill text-success me-2"></i> Mon–Sat 8am–6pm
                </div>
                <div className="booking-hero__badge">
                  <i className="bi bi-patch-check-fill text-success me-2"></i> Fast Response
                </div>
                <div className="booking-hero__badge">
                  <i className="bi bi-geo-alt-fill text-success me-2"></i> London & M25
                </div>
              </div>
            </div>
            <div className="col-lg-5">
              <div className="booking-hero__card">
                ...
                <p className="text-muted mb-3">Call our team directly for same-day and emergency bookings.</p>
            ...
            {CONTACT_CARDS.map((card, i) => (
              <div className="col-md-6 col-lg-3" key={i}>
                <div className="contact-card h-100">
                  ...
                  {card.lines.map((l, j) => (
                    <p key={j} className={`text-muted small mb-${j === card.lines.length - 1 ? '0' : '1'}`}>{l}</p>
                  ))}
                  {card.href && card.cta && (
                    <a href={card.href} target={card.href.startsWith('http') ? '_blank' : undefined}
                       rel="noopener noreferrer" className="btn-outline-green mt-3 d-inline-block" style={{ padding: '6px 16px', fontSize: '.85rem' }}>
                      {card.cta}
                    </a>
                  )}
                </div>
        ...
        <div className="container">
          <div className="row g-5 justify-content-center">
            <div className="col-lg-7">
              ...
              <p className="text-muted mb-4">Fill in the form below and one of our team will get back to you within 24 hours.</p>

              {/* Success state */}
              {status === 'success' && (
                <div className="contact-success-msg mb-4">
                  <div className="contact-success-msg__icon">
                    <i className="bi bi-check-circle-fill"></i>
                  </div>
                  <div>
                    <strong>Message Sent!</strong>
                    <p className="mb-0 text-muted small">Thank you for getting in touch. We will reply within 24 hours. Check your email for a confirmation.</p>
                  </div>
                </div>
              )}
