import { HOMEOWNER_GAS }  from '../../data/gasData';
...
const { hero, intro, benefits, pricing, whatsCovered, process: proc, related, faqs, cta } = HOMEOWNER_GAS;

export default function HomeownerGasPage() {
  return (
    <>
      <ServiceHero {...hero} />
      <IntroSection {...intro} />
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <img src={whatsCovered.imgSrc} alt="Homeowner gas safety check" className="intro-img" />
            </div>
            <div className="col-lg-6">
