...
const { hero, stats, intro, benefits, pricing, whatsCovered, process: proc, propertyTypes, related, faqs, cta } = CP42;

export default function CommercialCP42Page() {
  return (
    <>
      <ServiceHero {...hero} />
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <img src={whatsCovered.imgSrc} alt="Commercial kitchen gas safety inspection" className="intro-img" />
            </div>
            <div className="col-lg-6">
      ...
      <PageReviews title="What Our Catering Clients Say" />
      <CtaBanner title={cta} />
    </>
  );
}
