...
const { hero, stats, intro, benefits, pricing, whatsCovered, process: proc, related, faqs, cta } = CP12;

export default function LandlordGasSafetyPage() {
  return (
    <>
      <ServiceHero {...hero} />
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <img src={whatsCovered.imgSrc} alt="Gas safety inspection" className="intro-img" />
            </div>
            <div className="col-lg-6">
