import { COMM_GAS_ENGINEER } from '../../data/gasData';
...
const { hero, stats, intro, benefits, process: proc, related, faqs, cta } = COMM_GAS_ENGINEER;

export default function CommercialGasEngineerPage() {
  return (
    <>
      <ServiceHero {...hero} />
