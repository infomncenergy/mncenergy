import { COMM_FIRE_DOOR } from '../../data/fireData';
...
const { hero, stats, intro, benefits, pricing, whatsCovered, process: proc, propertyTypes, related, faqs, cta } = COMM_FIRE_DOOR;

export default function CommercialFireDoorPage() {
  return (
    <>
      <ServiceHero {...hero} />
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <img src={whatsCovered.imgSrc} alt="Commercial fire door inspection" className="intro-img" />
            </div>
            <div className="col-lg-6">
