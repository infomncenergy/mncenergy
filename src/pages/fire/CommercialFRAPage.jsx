import { COMM_FRA }       from '../../data/fireData';
...
const { hero, stats, intro, benefits, pricing, propertyTypes, process: proc, related, faqs, cta } = COMM_FRA;

export default function CommercialFRAPage() {
  return (
    <>
      <ServiceHero {...hero} />
