import { RES_FIRE_DOOR }  from '../../data/fireData';
...
const { hero, stats, intro, benefits, pricing, whatsCovered, process: proc, related, faqs, cta } = RES_FIRE_DOOR;

export default function ResidentialFireDoorPage() {
  return (
    <>
      <ServiceHero {...hero} />
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <img src={whatsCovered.imgSrc} alt="Fire door inspection checklist" className="intro-img" />
            </div>
            <div className="col-lg-6">
