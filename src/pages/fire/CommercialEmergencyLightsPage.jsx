import { COMM_EMERGENCY_LIGHTS } from '../../data/fireData';
...
const { hero, stats, intro, benefits, pricing, whatsCovered, process: proc, related, faqs, cta } = COMM_EMERGENCY_LIGHTS;

export default function CommercialEmergencyLightsPage() {
  return (
    <>
      <ServiceHero {...hero} />
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <img src={whatsCovered.imgSrc} alt="Commercial emergency lighting testing" className="intro-img" />
            </div>
            <div className="col-lg-6">
